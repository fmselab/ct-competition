...
The area of Combinatorial Interaction testing has seen tremendous progress over the last few years. Many tools have been developed but a comparison among algorithms and techniques is difficult to carry on.
...
- a **training phase**, in which example benchmarks are given to the tool developers (starting from beginning of Nov. 2024)
  - the example benchmarks can be found here: [ACTS](https://github.com/fmselab/ct-competition/raw/gh-pages/examples/ACTS2025.zip), [CTWedge](https://github.com/fmselab/ct-competition/raw/gh-pages/examples/CTWedge2025.zip) or [PICT](https://github.com/fmselab/ct-competition/raw/gh-pages/examples/PICT2025.zip).
...
| `UNIFORM` | Uniform | NO | *k*: number of parameters<br /><br /> *v*: number of elements for each parameter | *k*: random in the interval \[6, 30\]<br /><br /> *v*: random in the interval \[2, 15] | 15 |
| `MCA` | MCA | NO | *k*: number of parameters<br /><br /> *v\[\]*: array containing the number of elements for each parameter | *k*: random in the interval \[6, 30\]<br /><br /> each element of *v\[\]*: random in the interval \[2,15\] | 30 |
| `BOOLC` | Only booleans | randomly chosen between AND, OR, <=>, NOT, => | *k*: number of parameters<br /><br /> *c*: number of constraints<br /><br />*d\[\]*: array containing the complexity of each of the *c* constraints | *k*: random in the interval \[6, 30\]<br /><br /> *c*: random in the interval \[1, 100\]<br /><br /> each element of *d\[\]*: random in the interval \[1, 20\] | 30 |
...
## Important Dates
- November 6th 2024, the release of the benchmarks for training
